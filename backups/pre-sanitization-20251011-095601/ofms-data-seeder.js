...
const sourceDb = options.sourceDb || process.env.DATABASE_URL || 'postgresql://postgres:postgres-cbr!000Rr@localhost:5432/afarm_d';
const targetDb = options.targetDb || process.env.DATABASE_URL || 'postgresql://postgres:postgres-cbr!000Rr@localhost:5432/afarm_d';
