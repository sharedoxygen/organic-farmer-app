...
|------|-------|----------|------------------|
| **System Administrator** | admin@ofms.com | admin123 | Full system access, user management, system configuration |
| **Farm Manager** | sarah.chen@ofms.com | manager123 | Operations oversight, planning, resource allocation |
| **Operations Manager** | operations@ofms.com | manager123 | Daily operations, staff coordination |
| **Production Lead** | production.lead@ofms.com | lead123 | Production scheduling, batch management |
| **Quality Lead** | quality.lead@ofms.com | lead123 | Quality assurance, compliance management |
