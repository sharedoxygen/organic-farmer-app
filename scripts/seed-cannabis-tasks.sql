-- Cannabis Task Management Seed Data for Shared Oxygen Farms
...
-- Get some batch IDs for task associations
-- Note: These should be replaced with actual batch IDs from your batches
